...
/**
 * Gestionnaire global des exceptions pour commande-service.
 * Transforme les erreurs de validation (client ou produit introuvable, stock insuffisant)
 * en réponses HTTP claires plutôt qu'en erreur 500 générique.
 */
